...
var liner = function (exports, asmCrypto, elliptic) {
        ...
        if (!this.isHexOnly) {
          ...
          if (!sizeOnly) {
            for (var i = 0; i < size - 1; i++) {
              _retView3[i + 1] = encodedView[i] | 0x80;
            }
  ...
  var OctetString$1 = function (_BaseBlock7) {
    _inherits(OctetString$1, _BaseBlock7);
  ...
  var ObjectIdentifier$1 = function (_BaseBlock10) {
    _inherits(ObjectIdentifier$1, _BaseBlock10);
    ...
    _createClass(ObjectIdentifier$1, [{
      ...
      key: "toJSON",
      value: function toJSON() {
        return _objectSpread(_objectSpread({}, _get(_getPrototypeOf(ObjectIdentifier$1.prototype), "toJSON", this).call(this)), {}, {
          value: this.getValue()
        });
      }
    }]);
    ...
    _createClass(LocalRelativeSidValueBlock, [{
      ...
      value: function fromBER(inputBuffer, inputOffset, inputLength) {
        ...
        for (var _i10 = 0; _i10 < this.blockLength; _i10++) {
          tempView[_i10] = this.valueHexView[_i10];
        }
  ...
  var LocalStringValueBlock = function (_HexBlock9) {
    ...
    function LocalStringValueBlock() {
      ...
      var _ref18 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
          parameters = Object.assign({}, _ref18);
  ...
  var LocalSimpleStringBlock = function (_BaseStringBlock) {
    ...
    function LocalSimpleStringBlock() {
      var _ref19 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
          parameters = Object.assign({}, _ref19);
  ...
  var BmpString = function (_LocalBmpStringValueB) {
    ...
    function BmpString() {
      ...
      var _ref20 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
          parameters = Object.assign({}, _ref20);
  ...
  var UniversalString = function (_LocalUniversalString) {
    ...
    function UniversalString() {
      ...
      var _ref21 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
          parameters = Object.assign({}, _ref21);
    ...
    function UTCTime() {
      ...
      if (value) {
        ...
        for (var i = 0; i < value.length; i++) {
          _this43.valueBlock.valueHexView[i] = value.charCodeAt(i);
        }
      }
  ...
  function compareSchema(root, inputData, inputSchema) {
    ...
    if (inputSchema.primitiveSchema && VALUE_HEX_VIEW in inputData.valueBlock) {
      var _asn = localFromBER(inputData.valueBlock.valueHexView);
  ...
  var AsnSchemaStorage = function () {
    ...
    _createClass(AsnSchemaStorage, [{
      ...
      value: function get(target) {
        ...
        if (!schema) {
          throw new Error("Cannot get schema for '".concat((_c = (_b = (_a = target === null || target === void 0 ? void 0 : target.prototype) === null || _a === void 0 ? void 0 : _a.constructor) === null || _b === void 0 ? void 0 : _b.name) !== null && _c !== void 0 ? _c : target, "' target"));
        }
            ...
            if (typeof schemaItem.type === "number" || isConvertible$1(schemaItem.type)) {
              ...
              if (schemaItem.repeated) {
                if (schemaItem.implicit) {
                  ...
                  newItem.valueBlock = asn1Schema[_key5].valueBlock;
                  var _value = fromBER(newItem.toBER(false)).result.valueBlock.value;
                  res[_key5] = Array.from(_value, function (element) {
                    return _converter.fromASN(element);
                  });
                } else {
                  res[_key5] = Array.from(asn1Schema[_key5], function (element) {
                    return _converter.fromASN(element);
                  });
                }
              } else {
                var _value2 = asn1Schema[_key5];
              ...
              if (schemaItem.repeated) {
                ...
                res[_key5] = _this53.fromASN(asn1Schema[_key5], schemaItem.type);
              }
            }
          };
  ...
  var AesCbcProvider$1 = function (_AesProvider) {
    ...
    var _super74 = _createSuper(AesCbcProvider$1);
  ...
  var AesCtrProvider$1 = function (_AesProvider2) {
    ...
    var _super75 = _createSuper(AesCtrProvider$1);
  ...
  var AesEcbProvider$1 = function (_AesProvider3) {
    ...
    var _super76 = _createSuper(AesEcbProvider$1);
  ...
  var AesKwProvider$1 = function (_AesProvider5) {
    ...
    var _super78 = _createSuper(AesKwProvider$1);
    ...
    return _createClass(AesKwProvider$1);
  }(AesProvider);
  ...
  var RsaSsaProvider$1 = function (_RsaProvider) {
    ...
    var _super81 = _createSuper(RsaSsaProvider$1);
  ...
  var RsaOaepProvider$1 = function (_RsaProvider3) {
    ...
    var _super83 = _createSuper(RsaOaepProvider$1);
  ...
  var EcdsaProvider$1 = function (_EllipticProvider) {
    ...
    var _super85 = _createSuper(EcdsaProvider$1);
  ...
  var EcdhProvider$1 = function (_EllipticProvider2) {
    ...
    var _super86 = _createSuper(EcdhProvider$1);
  ...
  var EcdhEsProvider$1 = function (_EcdhProvider$) {
    ...
    var _super87 = _createSuper(EcdhEsProvider$1);
  ...
  var EdDsaProvider$1 = function (_EllipticProvider3) {
    ...
    return _createClass(EdDsaProvider$1);
  }(EllipticProvider);
  ...
  var HmacProvider$1 = function (_ProviderCrypto5) {
    ...
    var _super90 = _createSuper(HmacProvider$1);
  ...
  var Pbkdf2Provider$1 = function (_ProviderCrypto6) {
    ...
    var _super91 = _createSuper(Pbkdf2Provider$1);
  ...
  var Shake128Provider$1 = function (_ShakeProvider) {
    _inherits(Shake128Provider$1, _ShakeProvider);

    var _super93 = _createSuper(Shake128Provider$1);

    function Shake128Provider$1() {
      var _this79;

      _classCallCheck(this, Shake128Provider$1);
    ...
    return _createClass(Shake128Provider$1);
  }(ShakeProvider);

  var Shake256Provider$1 = function (_ShakeProvider2) {
    _inherits(Shake256Provider$1, _ShakeProvider2);

    var _super94 = _createSuper(Shake256Provider$1);

    function Shake256Provider$1() {
      var _this80;

      _classCallCheck(this, Shake256Provider$1);
    ...
    return _createClass(Shake256Provider$1);
  }(ShakeProvider);
  ...
  var Crypto$1 = function (_Symbol$toStringTag2) {
    ...
    _createClass(Crypto$1, [{
      ...
      value: function randomUUID() {
        ...
        return "".concat(uuid.substring(0, 8), "-").concat(uuid.substring(8, 12), "-").concat(uuid.substring(12, 16), "-").concat(uuid.substring(16));
      }
    }]);
  ...
  var AesCryptoKey = function (_CryptoKey) {
    ...
    var _super96 = _createSuper(AesCryptoKey);
    ...
    function AesCryptoKey(algorithm, extractable, usages, raw) {
      ...
      _this82 = _super96.call(this, algorithm, extractable, "secret", usages);
      _this82.raw = raw;
      return _this82;
    }
  ...
  var AesCbcProvider = function (_AesCbcProvider$) {
    ...
    var _super97 = _createSuper(AesCbcProvider);
  ...
  var AesEcbProvider = function (_AesEcbProvider$) {
    ...
    var _super98 = _createSuper(AesEcbProvider);
  ...
  var AesGcmProvider = function (_AesGcmProvider$) {
    ...
    var _super99 = _createSuper(AesGcmProvider);
  ...
  var AesCtrProvider = function (_AesCtrProvider$) {
    ...
    var _super100 = _createSuper(AesCtrProvider);
  ...
  var AesKwProvider = function (_AesKwProvider$) {
    ...
    var _super101 = _createSuper(AesKwProvider);
  ...
  var RsaCryptoKey = function (_CryptoKey2) {
    ...
    var _super102 = _createSuper(RsaCryptoKey);
    ...
    function RsaCryptoKey(algorithm, extractable, type, usages, data) {
      ...
      _this83 = _super102.call(this, algorithm, extractable, type, usages);
      _this83.data = data;
      return _this83;
    }
  ...
  var RsaOaepProvider = function (_RsaOaepProvider$) {
    ...
    var _super103 = _createSuper(RsaOaepProvider);
  ...
  var RsaPssProvider = function (_RsaPssProvider$) {
    ...
    var _super104 = _createSuper(RsaPssProvider);
  ...
  var RsaSsaProvider = function (_RsaSsaProvider$) {
    ...
    var _super105 = _createSuper(RsaSsaProvider);
  ...
  var RsaEsProvider = function (_ProviderCrypto8) {
    ...
    var _super106 = _createSuper(RsaEsProvider);
    ...
    function RsaEsProvider() {
      ...
      _this85 = _super106.apply(this, arguments);
  ...
  var EcCryptoKey = function (_CryptoKey3) {
    ...
    var _super107 = _createSuper(EcCryptoKey);
    ...
    function EcCryptoKey(algorithm, extractable, type, usages, data) {
      ...
      _this86 = _super107.call(this, algorithm, extractable, type, usages);
      _this86.data = data;
      return _this86;
    }
  ...
  var EcCrypto = function () {
    ...
    _createClass(EcCrypto, null, [{
      ...
      key: "concat",
      value: function concat() {
        for (var _len33 = arguments.length, buf = new Array(_len33), _key35 = 0; _key35 < _len33; _key35++) {
          buf[_key35] = arguments[_key35];
        }
  ...
  var EcdhProvider = function (_EcdhProvider$2) {
    ...
    var _super108 = _createSuper(EcdhProvider);
    ...
    function EcdhProvider() {
      ...
      _this88 = _super108.apply(this, arguments);
  ...
  var EcdsaProvider = function (_EcdsaProvider$) {
    ...
    var _super109 = _createSuper(EcdsaProvider);
    ...
    function EcdsaProvider() {
      ...
      _this89 = _super109.apply(this, arguments);
  ...
  var EdPrivateKey = function (_CryptoKey4) {
    ...
    var _super110 = _createSuper(EdPrivateKey);
    ...
    function EdPrivateKey(algorithm, extractable, usages, data) {
      ...
      _this90 = _super110.call(this, algorithm, extractable, "private", usages);
      _this90.data = data;
      return _this90;
    }
  ...
  var EdPublicKey = function (_CryptoKey5) {
    ...
    var _super111 = _createSuper(EdPublicKey);
    ...
    function EdPublicKey(algorithm, extractable, usages, data) {
      ...
      _this91 = _super111.call(this, algorithm, extractable, "public", usages);
      _this91.data = data;
      return _this91;
    }
  ...
  var EdCrypto = function () {
    ...
    _createClass(EdCrypto, null, [{
      ...
      key: "concat",
      value: function concat() {
        for (var _len34 = arguments.length, buf = new Array(_len34), _key36 = 0; _key36 < _len34; _key36++) {
          buf[_key36] = arguments[_key36];
        }
  ...
  var EdDsaProvider = function (_EdDsaProvider$) {
    ...
    var _super112 = _createSuper(EdDsaProvider);
    ...
    function EdDsaProvider() {
      ...
      _this93 = _super112.apply(this, arguments);
  ...
  var EcdhEsProvider = function (_EcdhEsProvider$) {
    ...
    var _super113 = _createSuper(EcdhEsProvider);
    ...
    function EcdhEsProvider() {
      ...
      _this94 = _super113.apply(this, arguments);
  ...
  var Sha1Provider = function (_ProviderCrypto9) {
    ...
    var _super114 = _createSuper(Sha1Provider);
    ...
    function Sha1Provider() {
      ...
      _this95 = _super114.apply(this, arguments);
      _this95.name = "SHA-1";
      _this95.usages = [];
      return _this95;
    }
  ...
  var Sha256Provider = function (_Sha1Provider) {
    ...
    var _super115 = _createSuper(Sha256Provider);
    ...
    function Sha256Provider() {
      ...
      _this96 = _super115.apply(this, arguments);
  ...
  var Sha512Provider = function (_Sha1Provider2) {
    ...
    var _super116 = _createSuper(Sha512Provider);
    ...
    function Sha512Provider() {
      ...
      _this97 = _super116.apply(this, arguments);
  ...
  var Sha3256Provider = function (_ProviderCrypto10) {
    ...
    var _super117 = _createSuper(Sha3256Provider);
    ...
    function Sha3256Provider() {
      ...
      _this98 = _super117.apply(this, arguments);
  ...
  var Sha3384Provider = function (_ProviderCrypto11) {
    ...
    var _super118 = _createSuper(Sha3384Provider);
    ...
    function Sha3384Provider() {
      ...
      _this99 = _super118.apply(this, arguments);
  ...
  var Sha3512Provider = function (_ProviderCrypto12) {
    ...
    var _super119 = _createSuper(Sha3512Provider);
    ...
    function Sha3512Provider() {
      ...
      _this100 = _super119.apply(this, arguments);
  ...
  var Shake128Provider = function (_Shake128Provider$) {
    ...
    var _super120 = _createSuper(Shake128Provider);
  ...
  var Shake256Provider = function (_Shake256Provider$) {
    ...
    var _super121 = _createSuper(Shake256Provider);
  ...
  var PbkdfCryptoKey = function (_CryptoKey6) {
    ...
    var _super122 = _createSuper(PbkdfCryptoKey);
    ...
    function PbkdfCryptoKey(algorithm, extractable, usages, raw) {
      ...
      _this101 = _super122.call(this, algorithm, extractable, "secret", usages);
      _this101.raw = raw;
      return _this101;
    }
  ...
  var Pbkdf2Provider = function (_Pbkdf2Provider$) {
    ...
    var _super123 = _createSuper(Pbkdf2Provider);
  ...
  var DesCryptoKey = function (_CryptoKey7) {
    ...
    var _super124 = _createSuper(DesCryptoKey);
    ...
    function DesCryptoKey(algorithm, extractable, usages, raw) {
      ...
      _this102 = _super124.call(this, algorithm, extractable, "secret", usages);
      _this102.raw = raw;
      return _this102;
    }
  ...
  var DesCbcProvider = function (_DesProvider) {
    ...
    var _super125 = _createSuper(DesCbcProvider);
    ...
    function DesCbcProvider() {
      ...
      _this103 = _super125.apply(this, arguments);
  ...
  var DesEde3CbcProvider = function (_DesProvider2) {
    ...
    var _super126 = _createSuper(DesEde3CbcProvider);
    ...
    function DesEde3CbcProvider() {
      ...
      _this104 = _super126.apply(this, arguments);
  ...
  var HmacCryptoKey = function (_CryptoKey8) {
    ...
    var _super127 = _createSuper(HmacCryptoKey);
    ...
    function HmacCryptoKey() {
      ...
      _this105 = _super127.call(this, algorithm, extractable, "secret", usages);
      _this105.kty = "oct";
      _this105.data = data;
      return _this105;
    }
  ...
  var HmacProvider = function (_HmacProvider$) {
    ...
    var _super128 = _createSuper(HmacProvider);
  ...
  var WrappedNativeCryptoKey = function (_CryptoKey9) {
    ...
    var _super129 = _createSuper(WrappedNativeCryptoKey);
    ...
    function WrappedNativeCryptoKey(algorithm, extractable, type, usages, nativeKey) {
      ...
      _this106 = _super129.call(this, algorithm, extractable, type, usages);
  ...
  var SubtleCrypto = function (_SubtleCrypto$) {
    ...
    var _super130 = _createSuper(SubtleCrypto);
    ...
    _createClass(SubtleCrypto, [{
      ...
      value: function deriveBits() {
        ...
        return __awaiter(this, void 0, void 0, regeneratorRuntime.mark(function _callee154() {
      ...
      value: function deriveKey() {
        ...
        return __awaiter(this, void 0, void 0, regeneratorRuntime.mark(function _callee155() {
      ...
      value: function wrapNative(method) {
        ...
        for (var _len47 = arguments.length, args = new Array(_len47 > 1 ? _len47 - 1 : 0), _key49 = 1; _key49 < _len47; _key49++) {
        ...
        return __awaiter(this, void 0, void 0, regeneratorRuntime.mark(function _callee156() {
          var nativeArgs, res, data, keyData, _res, _data, _keyData, _res2, _data2, _res3, _iterator20, _step20, arg, i, _arg, fn;
            ...
            while (1) {
              switch (_context156.prev = _context156.next) {
                ...
                case 61:
                  ...
                  _iterator20 = _createForOfIteratorHelper(args);
                  _context156.prev = 63;
                ...
                case 75:
                  _context156.prev = 75;
                  _context156.t4 = _context156["catch"](63);

                  _iterator20.e(_context156.t4);
          ...
          }, _callee156, this, [[1, 11], [15, 27], [31, 43], [47, 58], [63, 75, 78, 81]]);
        }));
      }
    }, {
      ...
      value: function castKey(key) {
        return __awaiter(this, void 0, void 0, regeneratorRuntime.mark(function _callee157() {
          var provider, jwk;
        ...
        if (this.browserInfo.name === Browser.Edge) {
          for (var i = 0; i < args.length; i++) {
            ...
            if (typeof arg === "string") {
              ...
              var _iterator22 = _createForOfIteratorHelper(this.providers.algorithms),
                  _step22;

              try {
                for (_iterator22.s(); !(_step22 = _iterator22.n()).done;) {
                  var _algorithm = _step22.value;
      ...
      value: function fixFirefoxEcExportPkcs8(args) {
        return __awaiter(this, void 0, void 0, regeneratorRuntime.mark(function _callee158() {
  ...
  var Crypto = function (_Crypto$) {
    ...
    var _super131 = _createSuper(Crypto);
    ...
    function Crypto() {
      ...
      _this109 = _super131.apply(this, arguments);
